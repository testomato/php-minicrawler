...
PHP_MINIT_FUNCTION(minicrawler)
{
	...
	REGISTER_LONG_CONSTANT("MCURL_OPT_NONSSL", MCURL_OPT_NONSSL, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("MCURL_OPT_CONVERT_TO_TEXT", MCURL_OPT_CONVERT_TO_TEXT, CONST_CS | CONST_PERSISTENT);
